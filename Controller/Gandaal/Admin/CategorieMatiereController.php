...
#[Route('/gandaal/admin/categorie/matiere')]
class CategorieMatiereController extends AbstractController
{
    #[Route('/', name: 'app_gandaal_admin_categorie_matiere_index', methods: ['GET'])]
    public function index(CategorieMatiereRepository $categorieMatiereRepository): Response
    {
        return $this->render('gandaal/admin/categorie_matiere/index.html.twig', [
            'categorie_matieres' => $categorieMatiereRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_gandaal_admin_categorie_matiere_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_gandaal_admin_matiere_new', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('gandaal/admin/categorie_matiere/new.html.twig', [
            'categorie_matiere' => $categorieMatiere,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_gandaal_admin_categorie_matiere_show', methods: ['GET'])]
    public function show(CategorieMatiere $categorieMatiere): Response
    {
        return $this->render('gandaal/admin/categorie_matiere/show.html.twig', [
            'categorie_matiere' => $categorieMatiere,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_gandaal_admin_categorie_matiere_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, CategorieMatiere $categorieMatiere, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_gandaal_admin_categorie_matiere_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('gandaal/admin/categorie_matiere/edit.html.twig', [
            'categorie_matiere' => $categorieMatiere,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_gandaal_admin_categorie_matiere_delete', methods: ['POST'])]
